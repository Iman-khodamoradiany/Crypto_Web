    ...
    return (
        <div className="w-full">
            <div className="w-full flex justify-center items-start flex-col gap-4">
                ...
                <div className="w-full flex justify-start items-center h-[50px] rounded-xl overflow-hidden bg-white gap-2 px-4">
                    <Icons Name={'Password'} />
                    <Field name={"Confirm"} className={'w-full h-full placeholder:font-[LightMotserrat] placeholder:text-[0.9vw] outline-none'} type={"password"} placeholder={"Password"} />
                </div>
                {errors.Confirm && <P className={"text-red-500 w-full"}>{errors.Confirm}</P>}
